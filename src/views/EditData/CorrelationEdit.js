...
import CorrelationDetailComp from '../../components/CorrelationTable/CorrelationDetailComp';

const CorrelationEdit = () => {
  //All state variables
  ...
  const CategoryById = () => {
    api
      .post('/category/getCorrelationById', { correlation_id: id })
      .then((res) => {
  ...
  const editCategoryData = () => {
    ...
    if (categoryDetails.software_version !== '') {
      api
        .post('/category/editCorrelation', categoryDetails)
        .then(() => {
  ...
  const deleteCategoryData = () => {
    api
      .post('/category/deleteCorrelation', { correlation_id: id })
      .then(() => {
...
export default CorrelationEdit;
