...
import ApplicationDonutDashboard from '../../components/dashboard/ApplicationDonutChart';
import { Button } from 'reactstrap';

const ApplicationMultiChart = () => {
  ...
  return (
    ...
    {(!category&&!subcategory )&&(!categoryids && !subCategoryid)&&<ApplicationDonutDashboard/>}
    </div>
  )
};

export default ApplicationMultiChart;
